                ...
                <div className='bg-white rounded-lg shadow p-6'>
                    ...
                    <form
                        ...
                        onSubmit={(e) => {
                             // stop page refresh
                            toast.promise(
                                handleSaveProfile(e), // properly wrapped promise
                                {
                                    loading: 'Saving...',
                                }
                            );
                    ...
                    >
                        ...
                        <div className='flex flex-col items-start gap-3'>
                            <label htmlFor="profile_picture" className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                <div className='group/profile relative'>
                                    ...
                                    <div className='absolute hidden group-hover/profile:flex top-0 bottom-0 right-0 left-0 bg-black/20 rounded-full items-center justify-center '>
                        ...
                        <div className='flex flex-col items-start gap-3 '>
                            <label htmlFor="cover_photo" className='block text-sm font-medium text-gray-700 mb-1'>
                                ...
                                <div className='group/cover relative'>
                                    <img className='w-80 h-40 rounded-lg bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 object-cover mt-2' src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo) : user.cover_photo} alt="coverPhoto" />
                                    <div className='absolute hidden group-hover/cover:flex top-0 bottom-0 right-0 left-0 bg-black/20  rounded-lg items-center justify-center' >
                                        <Pencil className='w-5 h-5 text-white' />
                                    </div>
                                </div>
                            </label>
                        ...
                        <div>
                            ...
                            <textarea rows={3} className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Enter the Bio' onChange={(e) => setEditForm({ ...editForm, bio: e.target.value })} value={editForm.bio} />
                        </div>
